...
$string['mform_select_learningpath_help'] = 'Wählen Sie den Lernpfad aus. Falls Sie einen Lernpfad anlegen möchten, nutzen Sie dafür den Lernpfad-Editor oder wenden Sie sich an eine dafür berechtigte Person.';
$string['mform_select_participantslist'] = 'Choose an option for how people get subscribed to the learning path';
$string['mform_select_participantslist_help'] = 'Steuert die Einschreibungen in den Lernpfad: (1) Alle Personen dieses Kurses sind automatisch auch in den Lernpfad eingeschrieben, die Kurseinschreibungen in die Kurse des Lernpfades geschehen dann entsprechend der jeweiligen Voraussetzungen.<br>(2) Jede Person, die in einen Kur der Start-Nodes eingeschrieben ist oder wird, wird automatisch in diesen Lernpfad eingeschrieben.<br>(3) Jede Person, die in irgendeinen Kurs dieses Lernpfades eingeschrieben ist oder wird, wird automatisch in diesen Lernpfad eingeschrieben.';
