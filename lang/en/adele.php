...
$string['mform_options_hostenrolmentmode_visible'] = 'Visible (learner gets access)';
...
$string['mform_select_hostenrolmentmode'] = 'Host course access for options "starting node" / "any node"';
$string['mform_select_hostenrolmentmode_help'] = 'Only relevant for participant options 2 ("starting node") and 3 ("any node") above — option 1 always enrols actively into this course. Visible: the learner is actively enrolled and can access this course. Hidden: an enrolment record is kept (visible in the participant list and countable for reports/certificates) but the learner gets no access. None: no enrolment is created here at all — only the learning path subscription happens.';
